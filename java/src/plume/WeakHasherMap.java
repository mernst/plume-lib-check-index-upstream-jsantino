...
/**
 * This is a modified version of {@link java.util.WeakHashMap} from JDK 1.2.2,
...
@SuppressWarnings({"interning", "keyfor", "index", "lock", "nullness", "purity", "regex"}) // old, non-typesafe Sun code, not worth annotating or checking.
